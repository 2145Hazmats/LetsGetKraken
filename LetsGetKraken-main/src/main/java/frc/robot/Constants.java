...
public final class Constants {
  ...
  public final class DriveConstants {
    ...
    public static final double kFrontLeftDriveAbsoluteEncoderOffsetRad = 200;
    ...
    public static final double kFrontRightDriveAbsoluteEncoderOffsetRad = 200;
    ...
    public static final double kBackLeftDriveAbsoluteEncoderOffsetRad = 200;
    ...
    public static final double kBackRightDriveAbsoluteEncoderOffsetRad = 200;
    ...
    public static final double kStickSlewLimitAccelerator = .02; //NEED TO MESS WITH THIS
